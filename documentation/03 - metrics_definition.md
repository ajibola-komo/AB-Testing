...
| Total Sessions | Total number of sessions associated with the overall experiment | `COUNT(*)` |  Executive Dashboard / Data Quality Dashboard |
| Total Conversions | Total number of converted sessions  | `count(case when is_converted = 1 then user_id end)` | Executive Dashboard |
| Session Conversion Rate (SCR) | Rate of conversions based on the total number of sessions | `Total Conversions` / `Total Sessions` | Executive Dashboard / Data Quality Dashboard |
